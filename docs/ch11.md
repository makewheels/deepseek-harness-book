...
最后看一眼官方的 **cordis 示例配置**：[cordis.yml](https://github.com/deepseek-ai/deepseek-harness/blob/master/apps/cli/config/examples/cordis/cordis.yml)（顶层 examples/ 退役后搬到这里）。它的全部配置就是一份覆盖层，核心只有两处（表11-6）：
