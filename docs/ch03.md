...
```mermaid
flowchart TB
    R["deepseek-harness 仓库"]
    R --> A["apps/<br/>两款成品App：cli 和 web"]
    R --> P["packages/<br/>约 50 个零件（本书主战场）"]
    R --> D["docs/<br/>官方说明书（中英双语）"]
    R --> E["examples/<br/>6 台可跑的样机车"]
    R --> V["vendor/<br/>Cordis 框架（插件系统的地基）"]
```
